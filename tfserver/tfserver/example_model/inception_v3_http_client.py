...
def grpc_inception_v3_client(target, num_tests, concurrency):
...
def http_inception_v3_client():
    import requests
    import json
    image = read_tensor_from_image_file("/Users/jinxiang/Downloads/imagenet/val/ILSVRC2012_val_00000003.JPEG")
    input_tensor = image.reshape([1, 299, 299, 3])
    url = "http://192.168.113.39:18501/v1/models/inception_v3:predict"
    request = {
...
if __name__ == '__main__':
    ...
    num_tests = 400
    concurrency = 4
    error_rate = grpc_inception_v3_client(target, num_tests, concurrency)
    print('\nInference error rate: %s%%' % (error_rate * 100))
    # http_inception_v3_client()
